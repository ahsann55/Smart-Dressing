...
class _AddProductState extends State<AddProduct> {
  bool isStitchedSelected = false;
  bool isUnStitchedSelected = true;
                            ...
                            Row(
                              children: [
                                MaterialButton(
                                  ...
                                  minWidth: 70,
                                  height: 40,
                                  color: isStitchedSelected
                                      ? Color(kBackgroundColor)
                                      : Colors.grey[200],
                                  onPressed: () {
                                    setState(() {
                                      isUnStitchedSelected = false;
                                      isStitchedSelected = true;
                                    });
                                  },
                                  child: Text(
                                    'Stitched',
                                ...
                                MaterialButton(
                                  ...
                                  minWidth: 70,
                                  height: 40,
                                  color: isUnStitchedSelected
                                      ? Color(kBackgroundColor)
                                      : Colors.grey[200],
                                  onPressed: () {
                                    setState(() {
                                      isUnStitchedSelected = true;
                                      isStitchedSelected = false;
                                    });
                                  },
                                  child: Text(
                                    'Unstitched',
