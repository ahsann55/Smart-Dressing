...
class UnStitchedProductsScreen extends StatefulWidget {
  const UnStitchedProductsScreen({Key key}) : super(key: key);
  static final String id = 'UnStitchedProductsScreen';

  @override
  _UnStitchedProductsScreenState createState() =>
      _UnStitchedProductsScreenState();
}

class _UnStitchedProductsScreenState extends State<UnStitchedProductsScreen> {
