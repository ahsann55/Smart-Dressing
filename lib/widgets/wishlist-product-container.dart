        ...
        children: [
          ...
          Padding(
            ...
            child: MaterialButton(
              onPressed: () {
                if (!isAddedToCart) {
                  LogInScreen.subTotal =
                      LogInScreen.subTotal + int.parse(widget.productPrice);
                  _fireStore
                      .collection('products')
                      .doc(widget.productId)
                      .update(
                    {'isAddedToCart': true, 'subTotal': LogInScreen.subTotal},
                  );
                } else {
                  LogInScreen.subTotal =
                      LogInScreen.subTotal - int.parse(widget.productPrice);
                  _fireStore
                      ...
                      .doc(widget.productId)
                      .update(
                    {'isAddedToCart': false, 'subTotal': LogInScreen.subTotal},
                  );
                }
                setState(() {
